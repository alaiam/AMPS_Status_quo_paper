...
weight.layer.per.poly <- t(t(layer_volume)/apply(layer_volume, FUN = function(x){sum(x,na.rm = T)}, MARGIN = 2))
weight.layer.per.poly <- array(rep(weight.layer.per.poly,730), dim = c(7,89,730))
...
plot_SSM_spatial <- function(variable.nc, variable.Atlantis, 
                             title1 = "Bottom ", title2 = "Bottom ", title3 = "Bottom "){
  ...
  #Layer 1 of input file in the bottom layer of the water column
  var2020 <- apply(var2020[1,,], FUN = function(x){sum(x,na.rm = T)}, MARGIN = 1)/730
  var2040 <- apply(var2040[1,,], FUN = function(x){sum(x,na.rm = T)}, MARGIN = 1)/730
  var2030 <- apply(var2030[1,,], FUN = function(x){sum(x,na.rm = T)}, MARGIN = 1)/730
  var2011 <- apply(var2011[1,,], FUN = function(x){sum(x,na.rm = T)}, MARGIN = 1)/730
  var2011[var2011==0] <- NA
  
  a_clean$D2020s <- var2020 - var2011
  a_clean$D2030s <- var2030 - var2011
  a_clean$D2040s <- var2040 - var2011
  
  p1 <- ggplot(a_clean, aes(fill = D2020s)) +
    geom_sf(data = a_clean[,"D2020s"])+
    scale_fill_gradient2(midpoint=0,  low="blue", mid="white",
                         high="red")+theme_bw()+
    ggtitle(title1)+ labs(fill = expression(Delta ~ "(2025 - 2011)"))
  
  p2 <- ggplot(a_clean, aes(fill = D2030s)) +
    geom_sf(data = a_clean[,"D2030s"])+
    scale_fill_gradient2(midpoint=0,  low="blue", mid="white",
                         high="red")+theme_bw()+
    ggtitle(title2) + labs(fill = expression(Delta ~ "(2035 - 2011)"))
  
  p3 <- ggplot(a_clean, aes(fill = D2040s)) +
    geom_sf(data = a_clean[,"D2040s"])+
    scale_fill_gradient2(midpoint=0,  low="blue", mid="white",
                         high="red")+theme_bw()+
    ggtitle(title3) + labs(fill = expression(Delta ~ "(2045 - 2011)"))
...
pdf("/home/atlantis/Status_quo/Spatial_bottom.pdf", height = 8, width = 16)
plot_SSM_spatial(variable.nc = "temperature", variable.Atlantis = "temperature", 
                 title1 = "Bottom temperature difference \nbetween 2025 and 2011",
                 title2 = "Bottom temperature difference \nbetween 2035 and 2011",
                 title3 = "Bottom temperature difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "salinity", variable.Atlantis = "salinity", 
                 title1 = "Bottom salinity difference \nbetween 2025 and 2011",
                 title2 = "Bottom salinity difference \nbetween 2035 and 2011",
                 title3 = "Bottom salinity difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "oxygen", variable.Atlantis = "Oxygen", 
                 title1 = "Bottom oxygen difference \nbetween 2025 and 2011",
                 title2 = "Bottom oxygen difference \nbetween 2035 and 2011",
                 title3 = "Bottom oxygen difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "NH4", variable.Atlantis = "NH3", 
                 title1 = "Bottom NH4 difference \nbetween 2025 and 2011",
                 title2 = "Bottom NH4 difference \nbetween 2035 and 2011",
                 title3 = "Bottom NH4 difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "NO3", variable.Atlantis = "NO3", 
                 title1 = "Bottom NO3 difference \nbetween 2025 and 2011",
                 title2 = "Bottom NO3 difference \nbetween 2035 and 2011",
                 title3 = "Bottom NO3 difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "SP", variable.Atlantis = "Sm_Phyto_N", 
                 title1 = "Bottom s.phytoplankton difference \nbetween 2025 and 2011",
                 title2 = "Bottom s.phytoplankton difference \nbetween 2035 and 2011",
                 title3 = "Bottom s.phytoplankton difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "LP", variable.Atlantis = "Lrg_Phyto_N", 
                 title1 = "Bottom l.phytoplankton difference \nbetween 2025 and 2011",
                 title2 = "Bottom l.phytoplankton difference \nbetween 2035 and 2011",
                 title3 = "Bottom l.phytoplankton difference \nbetween 2045 and 2011")
