...
for(i in 1:89){
  keep <- weight.layer.per.poly[,i][is.na(weight.layer.per.poly[,i])]
  weight.layer.per.poly[,i] <- c(rev(weight.layer.per.poly[,i][!is.na(weight.layer.per.poly[,i])]),keep)
}
...
plot_SSM_spatial <- function(variable.nc, variable.Atlantis, 
  ...
  var2020 <- apply(var2020*weight.layer.per.poly, FUN = function(x){sum(x,na.rm = T)}, MARGIN = 2)/730
  var2040 <- apply(var2040*weight.layer.per.poly, FUN = function(x){sum(x,na.rm = T)}, MARGIN = 2)/730
  var2030 <- apply(var2030*weight.layer.per.poly, FUN = function(x){sum(x,na.rm = T)}, MARGIN = 2)/730
  var2011 <- apply(var2011*weight.layer.per.poly, FUN = function(x){sum(x,na.rm = T)}, MARGIN = 2)/730
...
pdf("/home/atlantis/Status_quo/Spatial.pdf", height = 8, width = 16)
plot_SSM_spatial(variable.nc = "temperature", variable.Atlantis = "temperature", 
                 title1 = "Temperature difference \nbetween 2025 and 2011",
                 title2 = "Temperature difference \nbetween 2035 and 2011",
                 title3 = "Temperature difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "salinity", variable.Atlantis = "salinity", 
                 title1 = "Salinity difference \nbetween 2025 and 2011",
                 title2 = "Salinity difference \nbetween 2035 and 2011",
                 title3 = "Salinity difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "oxygen", variable.Atlantis = "Oxygen", 
                 title1 = "Oxygen difference \nbetween 2025 and 2011",
                 title2 = "Oxygen difference \nbetween 2035 and 2011",
                 title3 = "Oxygen difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "NH4", variable.Atlantis = "NH3", 
                 title1 = "NH4 difference \nbetween 2025 and 2011",
                 title2 = "NH4 difference \nbetween 2035 and 2011",
                 title3 = "NH4 difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "NO3", variable.Atlantis = "NO3", 
                 title1 = "NO3 difference \nbetween 2025 and 2011",
                 title2 = "NO3 difference \nbetween 2035 and 2011",
                 title3 = "NO3 difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "SP", variable.Atlantis = "Sm_Phyto_N", 
                 title1 = "S.Phytoplankton difference \nbetween 2025 and 2011",
                 title2 = "S.Phytoplankton difference \nbetween 2035 and 2011",
                 title3 = "S.Phytoplankton difference \nbetween 2045 and 2011")
plot_SSM_spatial(variable.nc = "LP", variable.Atlantis = "Lrg_Phyto_N", 
                 title1 = "L.Phytoplankton difference \nbetween 2025 and 2011",
                 title2 = "L.Phytoplankton difference \nbetween 2035 and 2011",
                 title3 = "L.Phytoplankton difference \nbetween 2045 and 2011")
